...
| 2.2.1 | (L1) Ensure 'Access Credential Manager as a trusted caller' is set to 'No One' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| 2.2.2 | (L1) Ensure 'Access this computer from the network' is set to 'Administrators, Authenticated Users, ENTERPRISE DOMAIN CONTROLLERS' (DC only) (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>) |
| 2.2.3 | (L1) Ensure 'Access this computer from the network' is set to 'Administrators, Authenticated Users' (MS only) (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| 2.2.4 | (L1) Ensure 'Act as part of the operating system' is set to 'No One' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| 2.2.5 | (L1) Ensure 'Add workstations to domain' is set to 'Administrators' (DC only) (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>) |
| 2.2.6 | (L1) Ensure 'Adjust memory quotas for a process' is set to 'Administrators, LOCAL SERVICE, NETWORK SERVICE' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| 2.2.7 | (L1) Ensure 'Allow log on locally' is set to 'Administrators' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| 2.2.8 | (L1) Ensure 'Allow log on through Remote Desktop Services' is set to 'Administrators' (DC only) (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>) |
| 2.2.9 | (L1) Ensure 'Allow log on through Remote Desktop Services' is set to 'Administrators, Remote Desktop Users' (MS only) (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| 2.2.10 | (L1) Ensure 'Back up files and directories' is set to 'Administrators' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| 2.2.11 | (L1) Ensure 'Change the system time' is set to 'Administrators, LOCAL SERVICE' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| 2.2.12 | (L1) Ensure 'Change the time zone' is set to 'Administrators, LOCAL SERVICE' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
...
| 2.3.1.4 | (L1) Configure 'Accounts: Rename administrator account' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
...
| 2.3.7.2 | (L1) Ensure 'Interactive logon: Don't display last signedin' is set to 'Enabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
...
| 2.3.10.2 | (L1) Ensure 'Network access: Do not allow anonymous enumeration of SAM accounts' is set to 'Enabled' (MS only) (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
...
| 2.3.11.6 | (L1) Ensure 'Network security: Force logoff when logon hours expire' is set to 'Enabled' (Manual) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
...
| 17.5.2 | (L1) Ensure 'Audit Group Membership' is set to include 'Success' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller Audit](<../GP Reports/Windows Server 2022 - Domain Controller Audit.htm>), [Windows Server 2022 - Member Server Audit](<../GP Reports/Windows Server 2022 - Member Server Audit.htm>) |
...
| 18.6.20.2 | (L2) Ensure 'Prohibit access of the Windows Connect Now wizards' is set to 'Enabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
...
| 18.9.27.4 | (L1) Ensure 'Enumerate local users on domain-joined computers' is set to 'Disabled' (MS only) (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| 18.9.27.5 | (L1) Ensure 'Turn off app notifications on the lock screen' is set to 'Enabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| 18.9.27.6 | (L1) Ensure 'Turn off picture password sign-in' is set to 'Enabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| 18.9.27.7 | (L1) Ensure 'Turn on convenience PIN sign-in' is set to 'Disabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
...
| 18.9.32.6.1 | (L2) Ensure 'Allow network connectivity during connected-standby (on battery)' is set to 'Disabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| 18.9.32.6.2 | (L2) Ensure 'Allow network connectivity during connected-standby (plugged in)' is set to 'Disabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| 18.9.32.6.3 | (L1) Ensure 'Require a password when a computer wakes (on battery)' is set to 'Enabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| 18.9.32.6.4 | (L1) Ensure 'Require a password when a computer wakes (plugged in)' is set to 'Enabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| **18.9.33** | **Recovery** | | |
...
| 18.9.35.1 | (L1) Ensure 'Enable RPC Endpoint Mapper Client Authentication' is set to 'Enabled' (MS only) (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| 18.9.35.2 | (L2) Ensure 'Restrict Unauthenticated RPC clients' is set to 'Enabled: Authenticated' (MS only) (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| **18.9.36** | **Removable Storage Access** | | |
| **18.9.37** | **Scripts** | | |
| **18.9.38** | **Security Account Manager** | | |
| 18.9.38.1 | (L1) Ensure 'Configure validation of ROCA-vulnerable WHfB keys during authentication' is set to 'Enabled: Audit' or higher (DC only) (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>) |
...
| 18.9.50.1.1 | (L2) Ensure 'Enable Windows NTP Client' is set to 'Enabled' (Automated) | :ballot_box_with_check: | [NTP Service - PDCe DC](<../GP Reports/NTP Service - PDCe DC.htm>), [NTP Service - Non-PDCe DC](<../GP Reports/NTP Service - Non-PDCe DC.htm>), [NTP Service - Client](<../GP Reports/NTP Service - Client.htm>) |
| 18.9.50.1.2 | (L2) Ensure 'Enable Windows NTP Server' is set to 'Disabled' (MS only) (Automated) | :ballot_box_with_check: | [NTP Service - Client](<../GP Reports/NTP Service - Client.htm>) |
...
| 18.10.7.1 | (L1) Ensure 'Disallow Autoplay for non-volume devices' is set to 'Enabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| 18.10.7.2 | (L1) Ensure 'Set the default behavior for AutoRun' is set to 'Enabled: Do not execute any autorun commands' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| 18.10.7.3 | (L1) Ensure 'Turn off Autoplay' is set to 'Enabled: All drives' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| **18.10.8** | **Biometrics** | | |
| **18.10.8.1** | **Facial Features** | | |
| 18.10.8.1.1 | (L1) Ensure 'Configure enhanced anti-spoofing' is set to 'Enabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| **18.10.9** | **BitLocker Drive Encryption** | | |
| **18.10.10** | **Camera** | | |
| 18.10.10.1 | (L2) Ensure 'Allow Use of Camera' is set to 'Disabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| **18.10.11** | **Chat** | | |
...
| **18.10.13** | **Connect** | | |
| 18.10.13.1 | (L1) Ensure 'Require pin for pairing' is set to 'Enabled: First Time' OR 'Enabled: Always' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| **18.10.14** | **Credential User Interface** | | |
| 18.10.14.1 | (L1) Ensure 'Do not display the password reveal button' is set to 'Enabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| 18.10.14.2 | (L1) Ensure 'Enumerate administrator accounts on elevation' is set to 'Disabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
...
| 18.10.17.1 | (L1) Ensure 'Enable App Installer' is set to 'Disabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| 18.10.17.2 | (L1) Ensure 'Enable App Installer Experimental Features' is set to 'Disabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| 18.10.17.3 | (L1) Ensure 'Enable App Installer Hash Override' is set to 'Disabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| 18.10.17.4 | (L1) Ensure 'Enable App Installer ms-appinstaller protocol' is set to 'Disabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
...
| 18.10.26.1.1 | (L1) Ensure 'Application: Control Event Log behavior when the log file reaches its maximum size' is set to 'Disabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller Audit](<../GP Reports/Windows Server 2022 - Domain Controller Audit.htm>), [Windows Server 2022 - Member Server Audit](<../GP Reports/Windows Server 2022 - Member Server Audit.htm>) |
| 18.10.26.1.2 | (L1) Ensure 'Application: Specify the maximum log file size (KB)' is set to 'Enabled: 32,768 or greater' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller Audit](<../GP Reports/Windows Server 2022 - Domain Controller Audit.htm>), [Windows Server 2022 - Member Server Audit](<../GP Reports/Windows Server 2022 - Member Server Audit.htm>) |
| **18.10.26.2** | **Security** | | |
| 18.10.26.2.1 | (L1) Ensure 'Security: Control Event Log behavior when the log file reaches its maximum size' is set to 'Disabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller Audit](<../GP Reports/Windows Server 2022 - Domain Controller Audit.htm>), [Windows Server 2022 - Member Server Audit](<../GP Reports/Windows Server 2022 - Member Server Audit.htm>) |
| 18.10.26.2.2 | (L1) Ensure 'Security: Specify the maximum log file size (KB)' is set to 'Enabled: 196,608 or greater' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller Audit](<../GP Reports/Windows Server 2022 - Domain Controller Audit.htm>), [Windows Server 2022 - Member Server Audit](<../GP Reports/Windows Server 2022 - Member Server Audit.htm>) |
| **18.10.26.3** | **Setup** | | |
| 18.10.26.3.1 | (L1) Ensure 'Setup: Control Event Log behavior when the log file reaches its maximum size' is set to 'Disabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller Audit](<../GP Reports/Windows Server 2022 - Domain Controller Audit.htm>), [Windows Server 2022 - Member Server Audit](<../GP Reports/Windows Server 2022 - Member Server Audit.htm>) |
| 18.10.26.3.2 | (L1) Ensure 'Setup: Specify the maximum log file size (KB)' is set to 'Enabled: 32,768 or greater' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller Audit](<../GP Reports/Windows Server 2022 - Domain Controller Audit.htm>), [Windows Server 2022 - Member Server Audit](<../GP Reports/Windows Server 2022 - Member Server Audit.htm>) |
| **18.10.26.4** | **System** | | |
| 18.10.26.4.1 | (L1) Ensure 'System: Control Event Log behavior when the log file reaches its maximum size' is set to 'Disabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller Audit](<../GP Reports/Windows Server 2022 - Domain Controller Audit.htm>), [Windows Server 2022 - Member Server Audit](<../GP Reports/Windows Server 2022 - Member Server Audit.htm>) |
| 18.10.26.4.2 | (L1) Ensure 'System: Specify the maximum log file size (KB)' is set to 'Enabled: 32,768 or greater' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller Audit](<../GP Reports/Windows Server 2022 - Domain Controller Audit.htm>), [Windows Server 2022 - Member Server Audit](<../GP Reports/Windows Server 2022 - Member Server Audit.htm>) |
| **18.10.27** | **Event Logging** | | |
| **18.10.28** | **Event Viewer** | | |
| **18.10.29** | **File Explorer (formerly Windows Explorer)** | | |
| **18.10.29.1** | **Previous Versions** | | |
| 18.10.29.2 | (L1) Ensure 'Turn off Data Execution Prevention for Explorer' is set to 'Disabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| 18.10.29.3 | (L1) Ensure 'Turn off heap termination on corruption' is set to 'Disabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| 18.10.29.4 | (L1) Ensure 'Turn off shell protocol protected mode' is set to 'Disabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
...
| 18.10.37.1 | (L2) Ensure 'Turn off location' is set to 'Enabled' (Automated) | :ballot_box_with_check: | [Diagnostics and Reporting - Computer](<../GP Reports/Diagnostics and Reporting - Computer.htm>) |
...
| 18.10.51.1 | (L1) Ensure 'Prevent the usage of OneDrive for file storage' is set to 'Enabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| **18.10.52** | **Online Assistance** | | |
| **18.10.53** | **OOBE** | | |
| **18.10.54** | **Portable Operating System** | | |
| **18.10.55** | **Presentation Settings** | | |
| **18.10.56** | **Push To Install** | | |
| 18.10.56.1 | (L2) Ensure 'Turn off Push To Install service' is set to 'Enabled' (Automated) | :white_large_square: | |
...
| 18.10.57.2.2 | (L1) Ensure 'Do not allow passwords to be saved' is set to 'Enabled' (Automated) | :ballot_box_with_check: | [Remote Desktop Service](<../GP Reports/Remote Desktop Service.htm>) |
...
| 18.10.57.3.2.1 | (L2) Ensure 'Restrict Remote Desktop Services users to a single Remote Desktop Services session' is set to 'Enabled' (Automated) | :ballot_box_with_check: | [Remote Desktop Service](<../GP Reports/Remote Desktop Service.htm>) |
...
| 18.10.57.3.11.2 | (L1) Ensure 'Do not use temporary folders per session' is set to 'Disabled' (Automated) | :ballot_box_with_check: | [Remote Desktop Service](<../GP Reports/Remote Desktop Service.htm>) |
| **18.10.58** | **RSS Feeds** | | |
| 18.10.58.1 | (L1) Ensure 'Prevent downloading of enclosures' is set to 'Enabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| **18.10.59** | **Search** | | |
| **18.10.59.1** | **OCR** | | |
...
| 18.10.59.3 | (L1) Ensure 'Allow indexing of encrypted files' is set to 'Disabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| 18.10.59.4 | (L2) Ensure 'Allow search highlights' is set to 'Disabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
...
| 18.10.80.1 | (L2) Ensure 'Allow suggested apps in Windows Ink Workspace' is set to 'Disabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| 18.10.80.2 | (L1) Ensure 'Allow Windows Ink Workspace' is set to 'Enabled: On, but disallow access above lock' OR 'Enabled: Disabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| **18.10.81** | **Windows Installer** | | |
| 18.10.81.1 | (L1) Ensure 'Allow user control over installs' is set to 'Disabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| 18.10.81.2 | (L1) Ensure 'Always install with elevated privileges' is set to 'Disabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| 18.10.81.3 | (L2) Ensure 'Prevent Internet Explorer security prompt for Windows Installer scripts' is set to 'Disabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| **18.10.82** | **Windows Logon Options** | | |
| 18.10.82.1 | (L1) Ensure 'Enable MPR notifications for the system' is set to 'Disabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| 18.10.82.2 | (L1) Ensure 'Sign-in and lock last interactive user automatically after a restart' is set to 'Disabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
...
| 18.10.92.2.1 | (L1) Ensure 'Prevent users from modifying settings' is set to 'Enabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| **18.10.93** | **Windows Update** | | |
| **18.10.93.1** | **Legacy Policies** | | |
| 18.10.93.1.1 | (L1) Ensure 'No auto-restart with logged on users for scheduled automatic updates installations' is set to 'Disabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Update](<../GP Reports/Windows Server 2022 - Update.htm>) |
| **18.10.93.2** | **Manage end user experience** | | |
| 18.10.93.2.1 | (L1) Ensure 'Configure Automatic Updates' is set to 'Enabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Update](<../GP Reports/Windows Server 2022 - Update.htm>) |
| 18.10.93.2.2 | (L1) Ensure 'Configure Automatic Updates: Scheduled install day' is set to '0 - Every day' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Update](<../GP Reports/Windows Server 2022 - Update.htm>) |
...
| 18.10.93.4.1 | (L1) Ensure 'Manage preview builds' is set to 'Disabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Update](<../GP Reports/Windows Server 2022 - Update.htm>) |
| 18.10.93.4.2 | (L1) Ensure 'Select when Preview Builds and Feature Updates are received' is set to 'Enabled: 180 or more days' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Update](<../GP Reports/Windows Server 2022 - Update.htm>) |
| 18.10.93.4.3 | (L1) Ensure 'Select when Quality Updates are received' is set to 'Enabled: 0 days' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Update](<../GP Reports/Windows Server 2022 - Update.htm>) |
| **19** | **Administrative Templates (User)** | | |
| **19.1** | **Control Panel** | | |
| **19.1.1** | **Add or Remove Programs** | | |
| **19.1.2** | **Display** | | |
| **19.1.3** | **Personalization (formerly Desktop Themes)** | | |
| 19.1.3.1 | (L1) Ensure 'Enable screen saver' is set to 'Enabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - User](<../GP Reports/Windows Server 2022 - User.htm>) |
| 19.1.3.2 | (L1) Ensure 'Password protect the screen saver' is set to 'Enabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - User](<../GP Reports/Windows Server 2022 - User.htm>) |
| 19.1.3.3 | (L1) Ensure 'Screen saver timeout' is set to 'Enabled: 900 seconds or fewer, but not 0' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - User](<../GP Reports/Windows Server 2022 - User.htm>) |
| **19.2** | **Desktop** | | |
| **19.3** | **Network** | | |
| **19.4** | **Shared Folders** | | |
...
| 19.7.4.1 | (L1) Ensure 'Do not preserve zone information in file attachments' is set to 'Disabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - User](<../GP Reports/Windows Server 2022 - User.htm>) |
| 19.7.4.2 | (L1) Ensure 'Notify antivirus programs when opening attachments' is set to 'Enabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - User](<../GP Reports/Windows Server 2022 - User.htm>) |
...
| 19.7.40.1 | (L1) Ensure 'Always install with elevated privileges' is set to 'Disabled' (Automated) | :ballot_box_with_check: | [Windows Server 2022 - Domain Controller](<../GP Reports/Windows Server 2022 - Domain Controller.htm>), [Windows Server 2022 - Member Server](<../GP Reports/Windows Server 2022 - Member Server.htm>) |
| **19.7.41** | **Windows Logon Options** | | |
| **19.7.42** | **Windows Media Player** | | |
| **19.7.42.1** | **Networking** | | |
| **19.7.42.2** | **Playback** | | |
| 19.7.42.2.1 | (L2) Ensure 'Prevent Codec Download' is set to 'Enabled' (Automated) | :white_large_square: | |
